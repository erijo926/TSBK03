...
GLuint phongshader = 0, plaintextureshader = 0, truncateshader = 0, addingshader = 0, filtershader = 0;
...
void init(void)
{
    ...
    truncateshader = loadShaders("truncateshader.vert", "truncateshader.frag");
    addingshader = loadShaders("addingshader.vert", "addingshader.frag");
    filtershader = loadShaders("filtershader.vert", "filtershader.frag");
...
//	glFlush(); // Can cause flickering on some systems. Can also be necessary to make drawing complete.
    ...
    runfilter(addingshader, fbo3, fbo1, fbo2);
    /*
    glUseProgram(addingshader);
    useFBO(0L, fbo2, fbo1);
    DrawModel(squareModel, addingshader, "in_Position", NULL, "in_TexCoord");
    */
